...
-- Hàm lọc: kiểm tra lá bài hệ nước, tộc máy móc và có thể triệu hồi đặc biệt.
function s.spfilter(c,e,tp)
	return c:IsAttribute(ATTRIBUTE_WATER) and c:IsRace(RACE_MACHINE) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
